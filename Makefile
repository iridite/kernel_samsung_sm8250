...
KBUILD_CFLAGS   := -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs \
		   ...
		   $(call cc-disable-warning, void-pointer-to-enum-cast) -Wno-misleading-indentation -Wno-unused-function -Wno-bool-operation \
		   -Wno-unsequenced $(call cc-disable-warning, void-pointer-to-int-cast) -Wno-unused-variable -Wno-pointer-to-int-cast $(call cc-disable-warning, pointer-to-enum-cast) \
		   -Wno-fortify-source -Wno-strlcpy-strlcat-size $(call cc-disable-warning, align-mismatch)
